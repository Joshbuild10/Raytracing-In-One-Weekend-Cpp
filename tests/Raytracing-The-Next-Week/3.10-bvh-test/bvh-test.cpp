        ...
        for (int b = -11; b < 11; b++)
        {
            ...
            if ((center - point3(4, 0.2, 0)).length() > 0.9)
            {
                ...
                if (choose_mat < 0.8)
                {
                    ...
                    auto center2 = center + vec3(0, random_double(0, .5), 0); // Sphere moves from its center C at time t=0 to C+(0,r/2,0) at time t=1, where r is a random number in [0,1):
                    spheres.add(make_shared<moving_sphere>(
